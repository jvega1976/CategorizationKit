 ...
 */
@interface NSCategorization : NSObject <NSCategoryDelegate>
 ...
 */
@property (strong,nonatomic) NSCategories* categories;
 ...
 */
- (void)setItems:(NSArray*)items andCategories:(NSCategories*)categories;
